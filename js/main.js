...
window.exportAnalyticsCSV = admin.exportAnalyticsCSV;
...
window.renderDailySummary = admin.renderDailySummary;
window.openDailySummaryDetail = admin.openDailySummaryDetail;
window.renderAnalytics = admin.renderAnalytics;
window.importJSON = admin.importJSON;
